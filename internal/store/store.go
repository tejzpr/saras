...
// Chunk represents a piece of source code with its vector embedding.
type Chunk struct {
	ID          string    `json:"id"`
...
// Document represents a file that has been indexed.
...
// SearchResult pairs a chunk with its relevance score.
...
// FileStats contains statistics for a single indexed file.
...
// EmbeddingCache is an optional interface for content-addressed embedding deduplication.
